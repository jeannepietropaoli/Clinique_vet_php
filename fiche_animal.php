...
<body class="p-0 text-center w-full">
    <header class="shadow-md w-full">
        <nav>
            <ul class="text-left ml-8 flex items-center">
                ...
                <li class="inline-block mr-6 p-5 border-b-4 border-indigo-700 hover:cursor-pointer"><a href="index.php">Accueil</a></li>
    ...
    <p>Voici la fiche animal selectionnee:</p>

    <?php 
    
        $controlleurAnimaux = new Controlleur_animaux();
        $controlleurAnimaux->afficherFicheAnimal();
    ?>
</body>
</html>