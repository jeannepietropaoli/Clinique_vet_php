<?php
    include_once "./mvc/controller/veterinaires/veterinaires.php";
?>
...
<body class="p-0 text-center w-full">
    <header class="shadow-md w-full">
        <nav>
            <ul class="text-left ml-8 flex items-center">
                ...
                <li class="inline-block mr-6 p-5 border-b-4 border-indigo-700 hover:cursor-pointer"><a href="veterinaires.php">Veterinaires</a></li>
    ...
    <p>Bienvenue a notre clinique de Quebec.Apprenez-en plus sur nous et notre equipe !</p>

    <div class="flex flex-col w-3/5 mx-auto mt-6 min-w-64">

    <?php
        $controlleur_veterinaires = new Controlleur_veterinaires;
        $controlleur_veterinaires->afficherCards();
    ?>
