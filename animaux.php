<?php
    include_once "./mvc/controller/animaux/animaux.php";
?>
...
<body class="p-0 text-center w-full">
    <header class="shadow-md w-full">
        <nav>
            <ul class="text-left ml-8 flex items-center">
                ...
                <li class="inline-block mr-6 p-5 border-b-4 border-indigo-700 hover:cursor-pointer"><a href="animaux.php">Animaux</a></li>
    ...
    <?php
       $controlleur_animaux = new Controlleur_animaux;
       $controlleur_animaux->afficherListe();
       $controlleur_animaux->afficherTableau();
       $controlleur_animaux->afficherTableauAvecBoutonsAction();
    ?>
</body>
</html>