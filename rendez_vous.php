<?php
    include_once "./mvc/controller/rdv/rdvs.php";
?>
...
<body class="p-0 text-center w-full">
    <header class="shadow-md w-full">
        <nav>
            <ul class="text-left ml-8 flex items-center">
                ...
                <li class="inline-block mr-6 p-5 border-b-4 border-indigo-700 hover:cursor-pointer"><a href="rendez_vous.php">Rendez-vous</a></li>
    ...
    <p>Voici les rendez-vous a la clinique !</p>

    <?php

        $controlleur_rdvs = new Controlleur_rdvs;
        $controlleur_rdvs->afficherTableau();
