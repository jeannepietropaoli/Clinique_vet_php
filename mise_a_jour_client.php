...
<body class="p-0 text-center w-full">
    ...
    <p>Voici le client a modifier:</p>

    <?php
        $controlleur_clients = new Controlleur_clients();
        $controlleur_clients->editer();
        // $controlleur_clients->editer(); //pourquoi avant l affichage
        $controlleur_clients->afficherFormulaireEdition();
